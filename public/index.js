 ...
 */ class Filter {
   ...
   */ static globalFilter = {
    ...
    /**
   * static array that stores current filter. Static to be able to access it from other classes (subfilterbtn).
   ...
   * @property {DOMarray} allProducts stores all products that were generated by PHP in array (destructured Dom array).
   * @property {function} updateFilterCount launches updateFilterCount.
   */ constructor(){
    ...
    /**
   * @property {function} generateFilterBtns
   * Adds eventlistener click to filter btns <br>
   * -> Changes active filter btn <br>
   * -> Changes globalFilter <br>
   * -> Launches filterProducts <br>
   * @returns {void}
   */ generateFilterBtns() {
   ...
   * Finally filters products again. <br>
   * @returns {void}
   */ clearFilters = ()=>{
        // Clearing checkboxes
        document.querySelectorAll(".color-checkbox").forEach((element)=>{
   ...
   * For all filters (color, brand, main category), it adds or removes "hidden" class according to info in globalFilter object <br>
   * If no filter is selected, it shows all products. <br>
   * After filters are looped, it updates filter count (function).
   * Finally, it checks whether there are any products left. If not, it shows "no products found" message.
   * @returns {void}
   */ filterProducts = ()=>{
        ...
        document.querySelectorAll(".product-card:not(.hidden)").length === 0 && document.querySelector("#emptyFilter").classList.remove("hidden");
    };
    /**
   ...
   */ generateSorter() {
    ...
    /**
   * @property {function} sortProducts(e)
   ...
   */ sortProducts = (e)=>{
    ...
    /**
   * @property {function} updateFilterCount
   * Loops over all subfilters and removes disabled class. <br>
   * Loops over all checkboxes and removes disabled attribute. <br>
   * Loops over all filterCount elements and updates count (span). <br>
   * If count is 0, it disables the checkbox and adds disabled class to subfilter. <br>
   * @returns {void}
   */ updateFilterCount = ()=>{
    ...
    /**
   * @property {function} countFilters(id)
   * method used by updateFilterCount to count how many products are left after filtering. <br>
   * @param {string} id - id of the filter (either color or brand) <br>
   * @returns {void}
   */ countFilters(id) {
        let count = 0;
